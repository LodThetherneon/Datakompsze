...
export default async function PolicyViewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <>
      {/* Sticky vissza sáv */}
      <div className="sticky top-0 z-10 bg-white/90 backdrop-blur border-b border-slate-200 px-8 py-3 flex items-center justify-between print:hidden">
        <Link
          href="/policies"
          className="text-[13px] font-semibold text-slate-500 hover:text-emerald-600 transition-colors"
        >
