    ...
    <html lang="hu">
      ...
      <body>
        <div className="no-print">
          <button className="btn-print" onClick={() => window.print()}>⬇ Mentés PDF-ként</button>
          <button className="btn-close" onClick={() => window.close()}>✕ Bezárás</button>
        </div>
        ...
        <script dangerouslySetInnerHTML={{ __html: `
          ...
          document.querySelector('.btn-close').addEventListener('click', function() { window.close(); });
        ` }} />
      </body>
    </html>
  )
